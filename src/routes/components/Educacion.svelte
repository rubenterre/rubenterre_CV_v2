  ...
  let educacion = [
    {
      ...
      institucion: "FORGA",
      descripcion:
        "Certificado que habilita para la docencia de los grupos A, B y C de la Formación Profesional.",
      pills: ["Docencia"],
    ...
    },
    {
      ...
      institucion: "CEC",
      descripcion:
        "Certificado de nivel 3 que habilita como técnico en desarrollo web.",
    ...
    },
    {
      ...
      descripcion:
        "Preparación de 2 años para la elaboración de productos de diseño gráfico e impresión digital.",
      pills: [
        "Photoshop",
        "Illustrator",
        "InDesign",
    ...
    },
    {
      ...
      descripcion:
        "Formación para la planificación de actividades de gestión cultural como exposiciones o conciertos.",
      pills: [
        "Marketing",
        "Gestión financiera",
    ...
    },
    {
      ...
      institucion: "Universidade de Santiago de Compostela",
      descripcion:
        "Especialización en historia, historia del arte y filología medieval europea.",
    ...
    },
    {
      ...
      institucion: "Universidade de Santiago de Compostela",
      descripcion:
        "Orientación en historia medieval, historia antigua y arqueología.",
      pills: [
        "Historia",
        "Historia antigua",
        "Historia medieval",
...
<div class="educacion__titulo">
  ...
  <div>
    <img
      src="combined-shape@2x.webp"
      alt="Flecha que indica que te puedes mover el scroll de forma horizontal"
      title="Flecha que indica que te puedes mover de forma horizontal"
    />
  </div>
</div>
  ...
  {#each educacion as item}
    <div class="educacion">
      ...
      <div class="educacion__detalles">
        ...
        <p class="educacion__tipo">{item.tipo}</p>
        <p class="educacion__institucion"><em>{item.institucion}</em></p>
        <p class="educacion__descripcion">{item.descripcion}</p>
        <div class="pills">
